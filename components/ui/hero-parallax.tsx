...
export const ProductCard = ({
  ...
  const content = (
    <>
      ...
      <div className="absolute inset-0 h-full w-full opacity-0 group-hover/product:opacity-80 bg-black-custom pointer-events-none"></div>
      <h3 className="absolute bottom-4 left-4 opacity-0 group-hover/product:opacity-100 text-white-custom">
        {product.title}
      </h3>
    </>
  );
